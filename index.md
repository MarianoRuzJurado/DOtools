...
installed for python environments. Some functions in this package depend
on Python packages or scripts. These functions use
...
result, a working conda installation is required.
