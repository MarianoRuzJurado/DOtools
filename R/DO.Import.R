...
DO.Import <- function(pathways,
  ...
  for (i in seq_along(pathways)) {
    ...
    #write QC to file
    prefilter_plot <- .suppressDeprecationWarnings(.QC_Vlnplot(sce_object = sce_object, id, layer = "counts"))
  ...
  #No idea why this is needed for seurat, but without the join and split doesnt work...
