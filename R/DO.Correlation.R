...
#' @description Generates a correlation heatmap from expression data to
...
#' @param group_by Column to aggregate the expression over it, default
#' "orig.ident"
...
#' @param auto_limits Automatically rescales the colour bar based on the values
#' in the correlation matrix, default "TRUE"
#' @param outline.color the outline color of square or circle. Default value is
#' "white".
#' @param colormap Defines the colormap used in the plot, default
#' c("royalblue4", "royalblue2","firebrick","firebrick4")
#' @param lab_size Size to be used for the correlation coefficient labels. used
#' when lab = TRUE.
#' @param lab logical value. If TRUE, add correlation coefficient on the plot.
#' @param lab_col color to be used for the correlation coefficient labels. used
#' when lab = TRUE.
